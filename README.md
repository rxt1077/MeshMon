...
* [`src/meshmon/`](src/meshmon/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/meshmon/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `meshmon` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/meshmon/config.cljs) defaults to `true` in
...
```clj
(ns meshmon.example
  (:require [meshmon.config :as config])
